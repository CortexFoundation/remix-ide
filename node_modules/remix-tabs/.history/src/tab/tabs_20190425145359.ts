...
export class RemixTabs extends LitElement {
  ...
  render(): TemplateResult {
    ...
    const dropdownList = html`
      <div class="dropdown p-2 " style="height: 32px;">
        ...
        <ul
          ...
          style="height: fit-content; list-style: none; visibility: hidden; position:relative;">
          ${tabNames}
        </ul>
      </div>`
    ...
    return html`
      <header class="header nav nav-tabs role="tablist" onscroll="${
        this.showTab(
          id = this.tabs.length - 1 || this.active
