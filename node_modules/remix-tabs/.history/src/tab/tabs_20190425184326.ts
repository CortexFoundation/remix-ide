...
export class RemixTabs extends LitElement {
  ...
  private tabsToShow: Partial<Tab>[] = [];
  ...
  document.addEventListener('wheel', (e) => {
    ...
    this.showTab(this.tabs[0].id)//this.tabs[this.tabs.indexOf(this.active) - 1 || this.tabs.length]
     // this.tabs[this.active || this.tabs.length-this.active + 1].id
  ...
  public addTab(tab: Tab): string {
    ...
    //if (this.style.width() > this.tabsToShow.length * tabElement.clientWidth)
     // this.tabsToShow = [...this.tabs, tab];
  ...
  render(): TemplateResult {
    ...
    const dropdownList = html`
      <div class="dropdown p-1 btn-light" style="
        right: 0px;
        position: absolute;
      ">
        ...
        <ul
          id="dropdownMenu"
          class="bg-light text-dark list-group"
          style="height: fit-content; list-style: none; visibility: hidden; position: fixed; right: 1px;">
          ${tabNames}
        </ul>
      </div>
    `
