...
export class RemixTabs extends LitElement {
  ...
  render(): TemplateResult {
    ...
    const tabNames = this.tabs.map(tab => {
      return html`<span class="list-group-item py-2 list-group-item-action cursor-pointer">${tab.title}</span>`
    })
    this.dropdownList = html`
      <div class="dropdown p-2 " style="height: 32px;">
        ...
        <ul
          id="dropdownMenu"
          class="bg-light text-dark border list-group"
