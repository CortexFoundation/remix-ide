...
export class RemixTabs extends LitElement {
  ...
  private collaps() {
    this.dropdownList.style.visible = !this.dropdownList.style.visible
  }
  ...
  render(): TemplateResult {
    ...
    this.dropdownList = html`
      <div class="dropdown">
        <span class="dropdown" @click="${this.collaps}">
          <i class="text-dark fas fa-caret" aria-hidden="true"></i>
        </span>
