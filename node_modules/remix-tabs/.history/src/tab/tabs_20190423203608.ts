...
export class RemixTabs extends LitElement {
  ...
  render(): TemplateResult {
    ...
    this.dropdownList = html`
      <div class="dropdown">
        <span class="dropdownCaret button" @click="${this.collaps}" style="height: 32px;">
          <i class="text-dark fas fa-caret-down" aria-hidden="true"></i>
        </span>
        <ul id="dropdownMenu" class="bg-light text-dark border" style="visibility: hidden; position:relative; height: 32px">
          ${tabNames}
        </ul>
      </div>`
