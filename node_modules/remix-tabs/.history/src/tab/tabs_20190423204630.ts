...
export class RemixTabs extends LitElement {
  ...
  render(): TemplateResult {
    ...
    const tabNames = this.tabs.map(tab => {
      return html`<span>${tab.title}</span>`
    })
    this.dropdownList = html`
      <div class="dropdown" style="height: 32px;">
        ...
        <div id="dropdownMenu" class="bg-light text-dark border" style="height: fit-content; visibility: hidden; position:relative; height: 32px">
          ${tabNames}
        </div>
      </div>`
