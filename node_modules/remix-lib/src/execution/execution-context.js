...
var web3
if (typeof window !== 'undefined' && typeof window.ctxWeb3 !== 'undefined') {
  injectedProvider = window.ctxWeb3.currentProvider
...
/*
  extend vm state manager and instanciate MV
*/
...
function ExecutionContext () {
  ...
  this.askPermission = function () {
    ...
    // cortexwallet
    //if (ctxWeb3.eth.defaultaccount) return true
  }
  ...
  this.detectNetwork = function (callback) {
    if (this.isVM()) {
      ...
      this.web3().version.getNetwork((err, id) => {
        var name = null
        if (err) name = 'Unknown'
        else if (id === '21') name = 'Mainnet'
        else if (id === '42') name = 'Dolores'
        else name = 'Custom'
...
var transactionDetailsLinks = {
  ...
  'Cerebro': 'https://cerebro-cn.cortexlabs.ai/#/tx/',
  'Main': 'https://cerebro.test.cortexlabs.ai/#/tx/',
